...
```bash
# 终端 1：基础设施
cd backend-java/src/main/resources && docker docker compose up -d
#导入mysql
Docker Compose 的 MySQL 只做了两件事：

创建空数据库 smart_tender_system ✅
设置 root 密码 1234 ✅
它不知道这个项目需要哪些表，表结构在 sql/smart_tender.sql 里，得手动导进去。

这是正常的——Docker 只提供数据库引擎，建表要么靠应用自动迁移（Spring Flyway），要么手动导入。这个项目刚好把 Flyway 关掉了（application.yml 里 flyway.enabled: false），所以只能手动导。

允许跑这条命令帮你导入C:\Users\li\Desktop\ai-bid-main\mysql

cp "C:/Users/li/Desktop/ai-bid-main/ai-bid-main/backend-java/src/main/resources/sql/smart_tender.sql" "C:/Users/li/Desktop/ai-bid-main/mysql/" && cp "C:/Users/li/Desktop/ai-bid-main/ai-bid-main/backend-java/src/main/resources/sql/test_data.sql" "C:/Users/li/Desktop/ai-bid-main/mysql/" 2>&1

cat "C:/Users/li/Desktop/ai-bid-main/mysql/smart_tender.sql" | docker exec -i smart-mysql mysql -uroot -p1234 smart_tender_system 2>&1
