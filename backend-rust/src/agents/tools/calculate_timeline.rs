...
impl CalculateTimelineTool {
    ...
    /// 包含 2024-2026 年的主要法定节假日。
    /// 每年需根据国务院办公厅最新通知更新。
    fn cn_holidays() -> Vec<(i32, u32, u32)> {
        vec![
            // 2024 春节: 2/10-2/17
            ...
            // 2026 春节: 2/17-2/23（预计）
            (2026,2,17),(2026,2,18),(2026,2,19),(2026,2,20),(2026,2,21),(2026,2,22),(2026,2,23),
            // 2026 清明: 4/5-4/6（预计）
            (2026,4,5),(2026,4,6),
            // 2026 劳动节: 5/1-5/5（预计）
            ...
            // 2026 端午: 5/31-6/2（预计）
            (2026,5,31),(2026,6,1),
            // 2026 中秋: 9/25-9/27（预计）
            (2026,9,25),(2026,9,26),(2026,9,27),
            // 2026 国庆: 10/1-10/7（预计）
