    ...
    fn definition(&self) -> serde_json::Value {
        serde_json::json!({
            ...
            "function": {
                ...
                "description": "【使用场景】检查采购文件中联合体投标条款的合规性——\
                    ① 判断条款是否明确允许/禁止联合体投标；\
                    ② 检查资质叠加规则是否合规（法定规则为'就低不就高'，用'叠加'方式违规）；\
                    ③ 检查联合体协议要求（联合体必须提交联合体协议）；\
                    ④ 检测矛盾（禁止联合体后出现联合体协议条款、同时出现禁止和允许表述）；\
                    ⑤ 检查牵头方要求是否过高。\
                    【不使用场景】不负责审核联合体协议的具体内容；\
                    不负责审核各联合体成员的具体资质条件。\
                    【法条依据】《政府采购法》第24条、《招标投标法》第31条。\
                    【注意】'就低不就高'是法定资质确定规则，不得以任何方式规避。",
                "parameters": {
                    "type": "object",
                    "properties": {
