...
public class PriceReasonablenessCheck extends AbstractLlmAuditCheck implements AuditCheck {
    public PriceReasonablenessCheck(PromptLoader promptLoader, LlmClient llmClient, JsonLinesIssueParser issueParser) {
