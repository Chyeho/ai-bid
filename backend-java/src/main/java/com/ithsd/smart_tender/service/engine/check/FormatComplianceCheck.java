...
public class FormatComplianceCheck extends AbstractLlmAuditCheck implements AuditCheck {
    public FormatComplianceCheck(PromptLoader promptLoader, LlmClient llmClient, JsonLinesIssueParser issueParser) {
